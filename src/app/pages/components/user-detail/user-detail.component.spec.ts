...
describe('UserDetailComponent', () => {
  ...
  beforeEach(async () => {
    authServiceMock = jasmine.createSpyObj(['dateRange', 'getUserDetails']);
    authServiceMock.getUserDetails.and.returnValue(of([]));
    await TestBed.configureTestingModule({
      ...
      providers: [{ provide: CommonService, useValue: authServiceMock }],
    })
      .compileComponents();
  });
  ...
  describe('#onSubmit()', () => {
    ...
    it('shows error message when #onSubmit() is errored out', () => {
      authServiceMock.getUserDetails.and.returnValue(throwError('Error'));
